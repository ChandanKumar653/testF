...
export default function SingleCard({ type = "ii", v }: any) {
    ...
    <>
      ...
      >
        <div
          ...
          onClick={() => {
            router.push(`/productDetail/${v?.ref?.id}`);
          }}
        >
          <img
            src={v?.itemVariants?.[0]?.media?.[0]?.url}
            style={styleForImage}
          ...
          >
            ...
            <Typography variant="caption" style={{ color: "black" }}>
              {/* ₹{v?.queryAttrs?.discountedPrice} */}
              <span style={{ textDecoration: "line-through" }}>
                {v?.queryAttrs?.price ? "₹" : ""} {v?.queryAttrs?.price}
              </span>
              &nbsp; &nbsp;
              <span> ₹{v?.queryAttrs?.discountedPrice}</span>
            </Typography>
          </div>
          {/* <div
            style={{
